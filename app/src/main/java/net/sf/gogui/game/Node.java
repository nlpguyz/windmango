    ...
    implements ConstNode
{
	...
	@Override
	public Node copy() {
		return new Node(m_move);
	}

	public boolean equals(Node node) {
		return super.equals(node) || m_move.equals(node);
	}
    ...
    public Node(Move move, boolean isTry)
    {
        m_move = move;
        m_tryNode = isTry;
    }
    
    public boolean isTryNode() {
    	return m_tryNode;
    }
...
//        try
//        {
//            m_comment = comment.getBytes("unicode");
//        }
//        catch (UnsupportedEncodingException e)
//        {
//            m_comment = comment.getBytes();
//        }
    ...
    private Move m_move;
    private boolean m_tryNode = false;
